...
async function addDataCorp(page, data) {
    try {
        ...
        await page.evaluate((data) => {
            ...
            if (nameField.value !== "Redberyltech Corp.") {
                throw new Error(`The value for the entity name is incorrect. It should be RedBerylTech Corp.`);
            }
    ...
    try {
        ...
        await page.evaluate((data) => {
            ...
            if (opt1 && opt1.checked) {
                ...
                document.querySelector('input[name="P3_SOP_ADDR1"]').value = data.Payload.Principal_Address.Address_Line1;
                document.querySelector('input[name="P3_SOP_ADDR2"]').value = data.Payload.Principal_Address.Address_Line2;
                document.querySelector('input[name="P3_SOP_CITY"]').value = data.Payload.Principal_Address.City;
                document.querySelector('input[name="P3_SOP_POSTAL_CODE"]').value = data.Payload.Principal_Address.Postal_Code;
            ...
            if (data.Payload.Registered_Agent) {
                ...
                document.querySelector('input[name="P3_RA_ADDR1"]').value = data.Payload.Registered_Agent.Address.Address_Line1;
                document.querySelector('input[name="P3_RA_ADDR2"]').value =  data.Payload.Registered_Agent.Address.Address_Line2;
                document.querySelector('input[name="P3_RA_CITY"]').value =  data.Payload.Registered_Agent.Address.City;
                document.querySelector('input[name="P3_RA_POSTAL_CODE"]').value = data.Payload.Registered_Agent.Address.Postal_Code;
...
if (clickedButton === 'ServiceCompany') {
  // Populate fields for Service Company
    ...
    document.querySelector('#P3_FILER_ADDR1').value = data.Payload.Principal_Address.Address_Line1;
    document.querySelector('input[name="P3_FILER_CITY"]').value = data.Payload.Principal_Address.City;
    document.querySelector('input[name="P3_FILER_POSTAL_CODE"]').value = data.Payload.Principal_Address.Postal_Code;
